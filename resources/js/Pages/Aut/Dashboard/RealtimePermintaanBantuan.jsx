...
export default function RealtimePermintaanBantuan() {
    const [notifPermintaan, setNotifPermintaan] = useState([]);
        ...
        const fetchDataGEmpa = async () => {
            try {
                const response = await axios
                    .get("api/get-data-bantuan")
                    .then((response) => {
                        setNotifPermintaan(response.data);
    ...
    // useEffect ini hanya dijalankan ketika notifPermintaan berubah
    ...
    return (
        <>
            ...
            >
                ...
                />
                {notifPermintaan.length > 0 &&
                    notifPermintaan.map((item) => (
